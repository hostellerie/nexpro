...
$sql="INSERT INTO {$_TABLES['nf_handlers']} ( `handler`, `nf_handlerTypeID`, `description`) VALUES ( 'testsuite/yes-no.php', 0, '')";
$res=DB_query($sql);
$handlerID=DB_insertID();
    
//FIRST TEST TEMPLATE
    
$sql="INSERT INTO {$_TABLES['nf_template']} ( templateName) VALUES ( 'TEST FLOW 1 - Manual Web Test')";
$res=DB_query($sql);
$insertID=DB_insertID();
$sql="INSERT INTO {$_TABLES['nf_templatevariables']} ( `nf_templateID`, `nf_variableTypeID`, `variableName`, `variableValue`) VALUES ({$insertID}, 0, 'INITIATOR', '')";
$res=DB_query($sql);

//insert first manual task and second IF task
$sql="INSERT INTO {$_TABLES['nf_templatedata']} ( `nf_templateID`, `logicalID`, `nf_stepType`, `nf_handlerId`, `firstTask`, `taskname`, `assignedByVariable`, `argumentVariable`, `argumentProcess`, `operator`, `ifValue`, `regenerate`, `regenAllLiveTasks`, `function`, `formid`, `optionalParm`, `reminderInterval`, `numReminders`, `escalateVariableID`, `last_updated`, `prenotify_message`, `postnotify_message`, `reminder_message`) VALUES ({$insertID}, 1, 1, '{$handlerID}', 1, 'Accept or Reject', 0, NULL, NULL, NULL, NULL, 1, 0, '', 0, 'op-parm-test', 0, 0, 0, '2006-09-20 10:40:38', '', '', '')";
$res=DB_query($sql);
$tfrom=DB_insertID();
$first=$tfrom;
$sql="INSERT INTO {$_TABLES['nf_templateassignment']} (`nf_templateDataID`, `uid`, `gid`, `nf_processVariable`, `nf_prenotifyVariable`, `nf_postnotifyVariable`, `nf_remindernotifyVariable`) VALUES ( {$first}, 2, NULL, NULL , NULL, NULL, NULL)";
$res=DB_query($sql);
...
$tto=DB_insertID();
$tfalse="NULL";
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($tfrom,$tto,$tfalse)";
$res=DB_query($sql);
...
$res=DB_query($sql);
$nextIF=DB_insertID();
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($tto,$nextIF,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($tfalse,$nextIF,NULL)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($nextIF,$last,$first)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_template']} ( `templateName`) VALUES ( 'TEST FLOW 2 - AND Test 1: 2 Branch')";
$res=DB_query($sql);
$insertID=DB_insertID();
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($first,$second,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($first,$third,NULL)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($second,$fourth,NULL)";
$res=DB_query($sql);


$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($third,$fourth,NULL)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fourth,$fifth,NULL)";
$res=DB_query($sql);

$sql="INSERT INTO {$_TABLES['nf_templateassignment']}  ( `nf_templateDataID`, `uid`, `gid`, `nf_processVariable`, `nf_prenotifyVariable`, `nf_postnotifyVariable`, `nf_remindernotifyVariable`) VALUES ( {$second}, 2, NULL, NULL, NULL, NULL, NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templateassignment']}  ( `nf_templateDataID`, `uid`, `gid`, `nf_processVariable`, `nf_prenotifyVariable`, `nf_postnotifyVariable`, `nf_remindernotifyVariable`) VALUES ( {$third}, 2, NULL, NULL, NULL, NULL, NULL)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_template']} ( `templateName`) VALUES ( 'TEST FLOW 3 - AND Test 2: 3 Branch Regen')";
$res=DB_query($sql);
$insertID=DB_insertID();
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($first,$third,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($first,$fourth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fourth,$fifth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fifth,$sixth,$fourth)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($second,$sixth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($third,$sixth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($sixth,$seventh,NULL)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_template']} ( `templateName`) VALUES ( 'TEST FLOW 4 - OR Test')";
$res=DB_query($sql);
$insertID=DB_insertID();
...
$sql="INSERT INTO {$_TABLES['nf_template']} ( `templateName`) VALUES ( 'TEST FLOW 5 - IF Test 1: Variable Value')";
$res=DB_query($sql);
$insertID=DB_insertID();
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($first,$second,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($second,$third,$fourth)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($third,$fifth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fourth,$fifth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fifth,$sixth,$seventh)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($sixth,$eighth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($seventh,$eighth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($eighth,$ninth,$tenth)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($ninth,$eleventh,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($tenth,$eleventh,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($eleventh,$twelveth,$thirteenth)";
$res=DB_query($sql);
...
$sql="INSERT INTO {$_TABLES['nf_template']} ( `templateName`) VALUES ( 'TEST FLOW 6 - IF Test 2: Task Status')";
$res=DB_query($sql);
$insertID=DB_insertID();
...
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fourth,$fifth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fifth,$sixth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($sixth,$seventh,$eighth)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($seventh,$thirteenth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($eighth,$thirteenth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($thirteenth,$fourteenth,NULL)";
$res=DB_query($sql);
$sql="INSERT INTO {$_TABLES['nf_templatedatanextstep']} (`nf_templateDataFrom`, `nf_templateDataTo`, `nf_templateDataToFalse`) values ($fourteenth,$fifteenth,$sixteenth)";
$res=DB_query($sql);
