...
/* Functions to support the custom notification features */
function selnotification(option) {
    if (option == 'custom') {
        document.getElementById('customnotification').style.display='';
    } else {
...
function showhide_options () {
    obj1 = document.getElementById('forumoptions');
    obj2 = document.getElementById('showoptions');      
    if (obj1.style.display == 'none') {
        obj1.style.display = '';
        obj2.innerHTML = 'Hide Options';
    } else {
        obj1.style.display = 'none';
        obj2.innerHTML = 'Show Options';          
    }
