...
$ts=new nexTime();
        ...
        $timesthru=0;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('H1', $LANG_NEXTIME_REPORTS['title_by_project']);
            ...
            while($A=DB_fetchArray($res)){
                ...
                $sql  ="SELECT * FROM {$_TABLES['nextime_timesheet_entry']} WHERE uid='{$A['uid']}' AND project_id='{$nexlistID}' ";
                $sql .="AND datestamp>={$startStamp} AND datestamp<={$endStamp} AND ( approved=1 ";
