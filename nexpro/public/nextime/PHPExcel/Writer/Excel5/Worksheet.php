...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
    ...
    */
    function PHPExcel_Writer_Excel5_Worksheet($BIFF_version, $name,
                                                ...
                                                &$url_format, &$parser)
    {
        global $_glob_fit_height, $_glob_fit_width;
        ...
        if ($_glob_fit_height != '' && $_glob_fit_width != '') {
            $this->_fit_page        = 1;
            $this->_fit_width       = $_glob_fit_width;
            $this->_fit_height      = $_glob_fit_height;
        }
        else {
            $this->_fit_page        = 0;
            $this->_fit_width       = 0;
    ...
    */
    function _initialize()
    {
        ...
        $fh = tmpfile();
//        $fh=fopen('C:/Inetpub/CogecoTimesheetSystem/nexpro_public/nextime/reports/output/' . time(),'w+');
        if ($fh) {
            // Store filehandle
            $this->_filehandle = $fh;
        } else {
