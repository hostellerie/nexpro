...
$LANG_INSTALL = array(
    ...
    52 => 'Sorry, but NexPro requires at least MySQL %s to run (you have version ',
    ...
    61 => 'Back',
    62 => 'Continue',
    63 => 'An installed NexPro database already exists. The installer will not allow you to run a fresh install on an existing NexPro database. To continue you must do one of the following:',
    64 => 'Delete the tables from the existing database. Or simply drop the database and recreate it. Then click "Retry" below.',
    65 => 'Perform an upgrade on your database (to a newer NexPro version) by selecting the "Upgrade" option below.',
    66 => 'Retry',
    67 => 'Error Setting up the NexPro Database', 
    68 => 'The database is not empty. Please drop all tables in the database and start again.',
    69 => 'Upgrading NexPro',
    70 => 'Before we get started it is important that you back up your database and the current NexPro files. This installation script will alter your NexPro database so if something goes wrong and you need to restart the upgrade process, you will need a backup of your original database. YOU HAVE BEEN WARNED!',
    71 => 'Please make sure to select the correct NexPro version you are coming from below. This script will do incremental upgrades after this version (i.e. you can upgrade directly from any old version to ',
    72 => ').',
    73 => 'Please note this script will not upgrade any beta or release candidate versions of NexPro.',
    ...
    76 => 'Select Your Current NexPro Version',
    77 => 'The installer was unable to determine your current version of NexPro, please select it from the list below:',
    78 => 'Upgrade Error',
    79 => 'An error occured while upgrading your NexPro installation.',
    80 => 'Change',
    81 => 'Stop!',
    82 => 'It is critical that you change permissions on the files listed below. NexPro will not be able to be installed until you do so.',
...
$LANG_SUCCESS = array(
    ...
    1 => 'Installation of NexPro ',
    2 => ' complete!',
    3 => 'Congratulations, you have successfully ',
    4 => ' NexPro. Please take a minute to read the information displayed below.',
    5 => 'To log into your new NexPro site, please use this account:',
    6 => 'Username:',
    7 => 'Admin',
    8 => 'Password:',
    9 => 'password',
...
$LANG_MIGRATE = array(
    ...
    4 => 'If you\'re upgrading from a NexPro version older than <strong>1.5.0</strong>, then make sure to copy over all your old <tt>config.php</tt> files so that the migration can pick up your settings.',
    5 => 'If you\'re upgrading to a new NexPro version, then don\'t upload your theme just yet. Use the included default theme until you can be sure your migrated site works properly.',
    ...
    14 => ' or if you experience a timeout, then you should upload the file to NexPro\'s backups directory via FTP.',
...
$LANG_PLUGINS = array(
    ...
    2 => 'Step',
    3 => 'NexPro plugins are addon components that provide new functionality and leverage the internal services of NexPro. By default, NexPro includes a few useful plugins that you may want to install.',
...
$LANG_HELP = array(
    0 => 'NexPro Installation Support',
    'site_name' => 'The name of your website.',
    'site_slogan' => 'A simple description of your website.',
    'db_type' => 'NexPro can be installed using either a MySQL or Microsoft SQL database. If you are not sure which option to select contact your hosting provider.</p><p class="indent"><strong>Note:</strong> InnoDB Tables may improve performance on (very) large sites, but they also make database backups more complicated.',
    ...
    'db_prefix' => 'Some users want to install multiple copies of NexPro on the same database. In order for each copy of NexPro to function correctly it must have its own unique table prefix (i.e. gl1_, gl2_, etc).',
    'site_url' => 'Make sure this is the correct URL to your site, i.e. to where NexPro\'s <code>index.php</code> file resides (no trailing slash).',
    'site_admin_url' => 'Some hosting services have a preconfigured admin directory. In that case, you need to rename NexPro\'s admin directory to something like "myadmin" and change the following URL as well. Leave as is until you experience any problems accessing NexPro\'s admin menu.',
    'site_mail' => 'This is the return address for all email sent by NexPro and contact info displayed in syndication feeds.',
