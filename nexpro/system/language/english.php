...
$LANG01 = array(
    ...
    39 => 'Refresh',
    40 => 'You have <tt>register_globals = Off</tt> in your <tt>php.ini</tt>. However, nexPro requires <tt>register_globals</tt> to be <strong>on</strong>. Before you continue, please set it to <strong>on</strong> and restart your web server.',
    41 => 'Guest Users',
    42 => 'Authored by:',
    43 => 'Reply to This',
    44 => 'Parent',
...
$LANG21 = array(
    ...
    40 => 'Left',
    41 => 'Right',
    42 => 'You must enter the block title and block order for nexPro default blocks.',
    43 => 'Homepage Only',
    44 => '',
...
$LANG32 = array(
    1 => 'Installing plugins could possibly cause damage to your nexPro installation and, possibly, to your system.  It is important that you only install plugins downloaded from the <a href="http://www.geeklog.net">Geeklog Homepage</a> as we thoroughly test all plugins submitted to our site on a variety of operating systems.  It is important that you understand that the plugin installation process will require the execution of a few filesystem commands which could lead to security problems particularly if you use plugins from third party sites.  Even with this warning you are getting, we do not gaurantee the success of any installation nor are we liable for damage caused by installing a plugin.  In other words, install at your own risk.  For the wary, directions on how to manually install a plugin is included with each plugin package.',
    ...
    9 => 'This plugin either requires a newer version of nexPro or requires another plugin to be installed before it. Either upgrade your copy of <a href="http://www.nextide.ca">nexPro</a>, get a newer version of the plugin or consult your plugin\'s documentation.',
...
$LANG_TRB = array (
    ...
    'autodetect_failed'  => 'nexPro could not detect the Trackback URL for the post you want to send your comment to. Please enter it manually below.',
    'trackback_explain'  => 'From the links below, please select the URL you want to send your Trackback comment to. nexPro will then try to determine the correct Trackback URL for that post. Or you can <a href="%s">enter it manually</a> if you know it already.',
