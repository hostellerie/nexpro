...
class procss_menu extends nexmenu {
    ...
    public function getHeaderCode() {
        ...
        if ($this->_type == 'header') {
            return LB . '<link rel="stylesheet" type="text/css" href="'.$_CONF['layout_url'].'/nexmenu/procssmenu/headermenu.css">' . LB;
        } elseif ($this->_type == 'block') {
            return LB . '<link rel="stylesheet" type="text/css" href="'.$_CONF['layout_url'].'/nexmenu/procssmenu/blockmenu.css">' . LB;
        }
    }
