...
$_SQL[] = "CREATE TABLE {$_TABLES['nxmenu']} (
...
$_SQL[] = "CREATE TABLE {$_TABLES['nxmenu_language']} (
...
$_SQL[] = "CREATE TABLE {$_TABLES['nxmenu_config']} (
...
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (12, 0, 1, 'block', 20, 'Home', '', '[siteurl]/index.php', 2, 1);";
...
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (10, 0, 1, 'block', 90, 'Menu Admin', '', '[siteadminurl]/plugins/nexmenu/index.php', 1, 1);";
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (11, 0, 1, 'block', 100, 'Logout', '', '[siteurl]/users.php?mode=logout', 13, 1);";
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (13, 0, 1, 'header', 10, 'Contribute', '', '[siteurl]/submit.php', 2, 1);";
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (14, 0, 4, 'header', 20, 'plugin_menuitems', '', 'pluginmenu', 2, 1);";
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (15, 0, 3, 'block', 40, 'Links', '', '', 2, 1); ";
$_SQL[]= "INSERT INTO {$_TABLES['nxmenu']} VALUES (16, 15, 4, 'block', 10, 'Link Items', '', 'linksmenu', 2, 1); ";
